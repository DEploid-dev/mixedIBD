...
15	&	  	&		    &4-4-4-4	\\
\end{tabular}
\caption{IBD configurations of number of strains are 2, 3 and 4.}\label{tab:encode}
\end{table}
...
\subsection{Combining clonal samples to make artificial mixtures}
\subsubsection{Filtering SNPs}
\begin{figure}
  \centering
  \includegraphics[width = \textwidth]{bgIBDvalidation/bgIBD.pdf}
\end{figure}
