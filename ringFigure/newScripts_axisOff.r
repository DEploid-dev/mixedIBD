...
#pdf("altVsRef.pdf");
jpeg("altVsRef_no_axis.jpg", height = 7, width = 7, res = 600, units = "in")
plotAltVsRef(myCoverageInfo$refCount, myCoverageInfo$altCount, cex.lab=1, title="");
dev.off()
...
jpeg("hap_post_prob_hap.jpg", height = 7, width = 18, res = 600, units = "in")
par(mar=c(0,0,0,0))
...
layout(matrix(c(rep(2,10),rep(3,10), rep(1,2),
                rep(4,10),rep(5,10), rep(1,2),
                rep(6,10),rep(7,10), rep(1,2)
                ), 3, 22, byrow=T))
...
legend("left", legend = c("","","","",""), col = c("brown1", "chartreuse", "yellow1", "gold", "orange"), pch = 15,  bty = "n", cex = 5, ncol = 1)
