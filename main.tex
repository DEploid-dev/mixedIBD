...
\tabledata{Summary of Pf3k samples in data release 5.1.  Genotyping, including both indel and SNP variants, was performed using a pipeline based on GATK best practices, see Methods. Data available from \url{ftp://ngs.sanger.ac.uk/production/pf3k/release_5/5.1}. $D$ mean read depth $\rho$ relatedness, $K$ effective k, $ss$ sample size}
\end{table}
...
% Dual infection only
%> table(new.data$cluster[africa.idx])/length(africa.idx)
%  HighSib     Other       Sib Unrelated
%0.2245370 0.2569444 0.2476852 0.2708333
%> table(new.data$cluster[asia.idx])/length(asia.idx)
%  HighSib     Other       Sib Unrelated
%0.4594595 0.1459459 0.2324324 0.1621622
