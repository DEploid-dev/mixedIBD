...
\begin{figure}[htp]
  ...
  \subfloat[][]{
    \includegraphics[width=0.7\textwidth]{ibdDistribution.png}
  }\\
  %\subfloat[][]{
...
\caption{Black dots show African samples for modelling, red dots are the predicted values\textcolor{red}{update with vivax}}
\end{figure}
