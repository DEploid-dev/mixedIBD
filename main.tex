...
balanced proportions or marginal strains (i.e. with a very low proportion) tend to produce chimeric haplotypes. Nonetheless, further research is needed to explore  factors that result in deconvolution failure. \textt{DEpoidIBD} performs slightly worse than the previous version of the software; we ascribe this to the fact that the simulations lack any complex IBD structure. See \ref{section:hap-quality} for more details about the procedure.
