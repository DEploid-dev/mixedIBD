...
\begin{figure}[ht]
  ...
  \subfloat[][]{\includegraphics[width=.4\textwidth]{figure_b.pdf}}
   ...
   \end{center}
   \figsupp{IBD chunk lengths from crosses.}{\includegraphics[width=\textwidth]{crosses_IBD_length.pdf}}
\end{figure}
