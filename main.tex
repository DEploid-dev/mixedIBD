...
In the rest of the paper, we will use LD-only-DEploid to refer to the previous version of DEploid, and IBD-LD-DEploid to refer to the current impelemtation.

Similar to \citep{Zhu2017}, we validate IBD-LD-DEploid using the same set of {\it in vitro} mixtures created by \citep{Wendler2015} to simulate mixed infections, which included 27 samples of which DNA extracted from four laboratory parasite lines: 3D7, Dd2, HB3 and 7G8, and mixed with different proportions (see supplementary material Fig.\todo{figure id}).

For details of this experiment please refer to the supplementary material.
