...
\begin{figure}[htp]
  ...
  \figsupp{Simulation study overview}
...
% case ID, Fraction of infer correct K, Fraction of overestimating K, Fraction of underestimating K, mean Effective K (sd), mean relatedness (sd), mean N50 (sd)
