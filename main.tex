...
\begin{figure}[ht]
  \begin{center}
  \subfloat[][]{\includegraphics[width=0.48\textwidth]{placeholder.png}}
  \subfloat[][]{\includegraphics[width=0.48\textwidth]{figure_b.pdf}}
  \\
  \subfloat[][]{\includegraphics[width=\textwidth]{figure_c.pdf}}
