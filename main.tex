...
\begin{figure}[ht]
  ...
  \subfloat[][]{\includegraphics[width=.4\textwidth]{figure_b.pdf}}
   ...
   \end{center}
   \figsupp{IBD chunk lengths from crosses.}{\includegraphics[width=0.5\textwidth]{figure_b_asia.pdf}}
   \figsupp{IBD chunk lengths from crosses.}{\includegraphics[width=0.5\textwidth]{figure_b_africa.pdf}}
