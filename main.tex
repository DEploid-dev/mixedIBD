...
\begin{figure}[htp]
  ...
  \subfloat[][]{
  \includegraphics[width = 0.7\textwidth]{GambiaIBD_correlation.png}
  }\\
  \caption{(a) IBD fractions across genome of Gambia samples. Red purple and green colors indicate the fraction of the genomes are IBD. (b) Pairwise correlations of IBD fractions between mixed Gambia samples.}\label{fig:gambia}
\end{figure}
...
\caption{\textcolor{red}{update with vivax}}
\end{figure}
