...
\texttt{DEploidIBD} estimates the correct proportions at all relatedness levels.
...
\begin{figure}[htp]
  \begin{center}
    ...
    \caption{.} \label{fig:error-analysis}
  \end{center}
\end{figure}
