...
Because parasite genetic distance in Africa is generally greater than Asia, a random choice of 20 reference strains in Africa does not work as well as in Asia. As a result, both the per site genotype error and haplotype switch error have raised more than twice as much compare to Asia.


We further extended benchmarking to \emph{in silico} mixtures of three strains in both Asian and African populations (Figure~\ref{fig:benchmark} A).
