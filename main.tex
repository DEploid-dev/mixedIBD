...
1. Summary of advances and why important.
2. Surprising finding of high sibling infection rate and why important.
3. Findings from model - informal explanation.  Why are Asia and Africa so different?
