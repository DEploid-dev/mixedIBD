...
\begin{figure}[htp]
  \centering{}
  \subfloat[][]{
    \includegraphics[width=0.8\textwidth]{beeswarm_effect_k.png}
  }\\
  \subfloat[][]{
  \includegraphics[width = 0.8\textwidth]{ibd_frac_hist.png}
  }\\
  \subfloat[][]{
  ...
  %}\\
  \caption{Schematic approach. Black box indicates when DEploid is used. Purple box indicates output.}
...
\subsection{Monitoring malaria epidemic from the IBD configuration}
\begin{figure}[htp]
  \centering{}
  \subfloat[][]{
...
Independence between effective k and IBD fraction.
