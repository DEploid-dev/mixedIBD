...
After accounting for between-continent differences in prevalence, the effective number of strains is a significant predictor of local prevalence (linear model $P = 1.73 \times 10^{-5}$), as well as the the level of relatedness ($P = 8.5\times10^{-3}$). Although, when combining both the effective number of strains and the level of relatedness, only the effective number of strains is a significant predictor ($P = 3.4 \times10^{-4}$) (Figure~\ref{fig:model}).  The relationship between the effective number of strains and prevalence is driven entirely by the African populations ($P = 1.6\times10^{-4}$), likewise for the level of relatedness $P = 1.2\times10^{-3}$. Both variables are significant predictor of local prevalence in Africa either by itself or in combination with the other. On the contrary, within the Asian populations, neither the effective number of strains and the level of relatedness are significant predictors of the prevalence ($P = 0.45$ and $P = 0.09$ respectively).
