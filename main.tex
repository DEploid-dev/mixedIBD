...
\begin{figure}[htp]
  ...
  \figsupp{Simulation study overview. We conduct simulation studies to mimic mixtures of 2, 3 and 4 strains. For each mixture, the left column illustrate the overall relationship between strains: black dots indicate strains. If two dots are connected by the black line, it implies the two strains are sibs. The right column show specific haplotype structure compare to the parents. For example.}
