...
In addition, we consider the scenario of


(Figure~\ref{fig:benchmark}--Supplement~2)

In addition to benchmark our methods in cases of co-infection and super-infection, we



 Similar to the previous experiment for check
