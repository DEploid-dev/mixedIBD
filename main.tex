...
We use hyphen connected strain IDs to denote the IBD-state, indicate IBD-sharing between strains, i.e. for two strains, the states ``1-1'' and ``1-2'' imply cases of non-IBD and IBD; ``1-2-2'' suggest that there are 3 strains, and strains 2 and 3 are IBD sharing.
