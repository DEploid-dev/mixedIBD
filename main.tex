...
\tabledata{Pf3k data release 5.1.  Genotyping, including both indel and SNP variants, was performed using a pipeline based on GATK best practices.}
\end{table}
